...
class Validator
{
     ...
     * @throws StaticValidatorException when called function not starts with check
     *                                  or function name cannot be recognized
     */
     ...
     * @param array $args array with datatype name to check
     *                                  and optional not to reverse returned bool value
     * @return bool
